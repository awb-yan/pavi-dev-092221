...
class AccountMoveBatch(models.Model):
    ...
    def _default_journal(self):
        ...
        journal_type = 'sale'
        company = self._get_company_default()

        journal = journal_obj.search([('type','=',journal_type), ('company_id', '=', company.id)])
        return journal
    ...
    def action_invoice(self):
        ...
        if self.state == 'confirm' and len(self.account_move_ids) == 0:
