...
class SMS(models.Model):
    ...
    def send_now(
        ...
        if recordset and send_type != "generic":
            ...
            _logger.info(f'  Raw Template Body: {raw_template_body}')
            _logger.info(f'  Format Keys: {format_keys}')
            ...
            for record in recordset:
                ...
                if send_type == "on_demand":
                    _logger.info(f'    On demand send type')
                    ...
                    if has_issues:
                        _logger.info(f'      {record} has issues')
                ...
                _logger.info(f'raw_template_body.format_map(key_value): {raw_template_body.format_map(key_value)}')
